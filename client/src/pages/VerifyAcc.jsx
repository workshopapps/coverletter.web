			...
			<div className="bg-[#ffff] px-[15.5px] py-[32px] md:p-[64px] text-center rounded-[8px] my-0 mx-auto w-fit">
				<div className="flex flex-col gap-[44px]">
					...
					<div className="flex gap-[16px]">
						<Button
							className={"btn btnSecondary w-[100%] btnShort"}
							children={"Resend OTP"}
						/>
						<Button
							className={"btn btnPrimary w-[100%] btnShort"}
							children={"Validate OTP"}
						/>
					</div>
				</div>
				<p className="font-semibold text-primaryMain text-base underline underline-offset-[5px] cursor-pointer mt-[24px]">
					Change email
				</p>
			</div>
		</div>
