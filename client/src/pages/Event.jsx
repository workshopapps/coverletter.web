...
const Event = () => {
	...
	return (
		<section className="bg-eventshome w-full h-full">
			<h1 className="text-center font-semibold md:font-bold text-2xl md:text-3xl lg:text-5xl px-4 pt-8">
				View our Scheduled Events here.
			</h1>
			<div
				id="events_page"
				className="bg-eventshome w-full h-full md:grid md:grid-cols-12 pb-12"
			>
				<div
					id="md_right_bar"
					className="md:col-span-5 md:w-80 lg:w-auto p-6 md:p-10"
				>
					...
					<div id="date" className="mb-6 md:mb-10">
						...
						<div className={`${dateState ? "block" : "hidden"}`}>
							<p className="text-selectdesc mb-4">
								Select any date
							</p>
							<div className="day mb-4 text-grey400 bg-white h-12 w-11/12 py-3 pl-3 rounded-r-lg border-l-blue-600 border-l-4">
								<span>Today</span>
							</div>
							<div className="day mb-4 text-grey400">
								<span>Tomorrow</span>
							</div>
							<div className="day mb-4 text-grey400">
					...
					<div id="category" className="mb-6 md:mb-10">
						...
						<div className={`${cateState ? "block" : "hidden"}`}>
							...
							<div className="cate-item mb-4 text-grey400 bg-white h-12 w-11/12 py-3 pl-3 rounded-r-lg border-l-blue-600 border-l-4">
								<span>Convention</span>
							</div>
							<div className="cate-item mb-4 text-grey400">
								<span>Seminar</span>
							</div>
							<div className="cate-item mb-4 text-grey400">
								<span>Workshop</span>
					...
					<div id="calender" className="mb-6 md:mb-10">
						...
						<p className="text-grey400 font-bold md:font-normal">
							Click on date to see scheduled event for that day.
						</p>
					</div>
				</div>
				...
				<div
					id="md_left_bar"
					className="md:col-span-7 px-6 md:pl-10 mb-16"
				>
					<h1 className="text-grey800 font-bold text-2xl pt-1 md:pt-10 pb-6">
						Upcoming Events
					</h1>
					<EventsList
						event={{
