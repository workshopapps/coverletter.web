...
import lockedCover from '../Assets/cover_letter_full_2.jpg'
...
const Preview = () => {
  ...
  return (
    <div className='bg-background pt-6 pb-36 overflow-x-hidden'>
        ...
        <svg width="36" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14.355 8.89453L5.25 17.9995L14.355 27.1045" stroke="#434343" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M30.7489 18H5.50391" stroke="#434343" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
            <p className='ml-3 text-sm font-bold'>Back</p>
        </div>
        ...
        <div className='w-screen overflow-x-hidden relative mt-10 md:mt-20'>
            <div className='flex relative w-full justify-center items-center md:translate-x-0 lg:translate-x-0'>
                <img src={lockedCover} alt="cover" className='mt-10 flex rounded-lg justify-center items-center bg-primaryLightest drop-shadow-lg min-w-[295px] h-[300px] min-h-[300px] md:min-h-[485px] md:min-w-[400px]' />
                ...
                <div className='flex justify-center items-center w-[80%] bg-primaryLightest drop-shadow-lg max-w-[530px] min-w-[395px] min-h-[410px] md:min-h-[725px] py-2 rounded-lg md:w-auto md:min-w-[525px] lg:scale-[90%]' role='button' onClick={coverRedirect}>
                   <CoverLetter/>
                </div>
