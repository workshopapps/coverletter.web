...
const Preview = () => {
  ...
  const testDOCXDownload = async () => {
    ...
    const preHTML =
      `<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w='urn:schemas-microsoft-com:office:word' xmlns='http://www.w3.org/TR/REC-html40'><head>${head.innerHTML}<meta charset='utf-8'></head><body>`;
    const postHTML = "</body></html>";
    const html = preHTML + domToSave.innerHTML + postHTML;
  ...
  // Handle the click button event depending on the state selected
  ...
  return (
    <div className="bg-background pt-6 pb-36 overflow-x-hidden">
      <div className="flex items-center px-7 lg:px-40 lg:mt-6">
        ...
        >
          <path
            d="M14.355 8.89453L5.25 17.9995L14.355 27.1045"
            stroke="#434343"
            strokeWidth="1.5"
            strokeMiterlimit="10"
            strokeLinecap="round"
      ...
      <div className="w-screen overflow-x-scroll md:overflow-x-hidden relative mt-10 md:mt-20">
        <div className="flex relative w-full justify-center overflow-x-scroll md:justify-center items-center md:translate-x-0 lg:translate-x-0">
          ...
          <div className="md:mr-[-25px]">
            <svg
              className="w-[15] h-[15px]md:w-[32px] md:h-[30px] "
              height="8"
              viewBox="0 0 17 8"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="w-full">
                <div className="flex justify-between w-full mt-7">
                  <div className=" flex items-center">
                    ...
                    >
                      <path
                        d="M10.4997 8.63379H5.83301C5.55967 8.63379 5.33301 8.40712 5.33301 8.13379C5.33301 7.86046 5.55967 7.63379 5.83301 7.63379H10.4997C10.773 7.63379 10.9997 7.86046 10.9997 8.13379C10.9997 8.40712 10.773 8.63379 10.4997 8.63379Z"
                        fill="#101010"
                      />
                      <path
                        d="M8.75301 11.2998H5.83301C5.55967 11.2998 5.33301 11.0731 5.33301 10.7998C5.33301 10.5265 5.55967 10.2998 5.83301 10.2998H8.75301C9.02634 10.2998 9.25301 10.5265 9.25301 10.7998C9.25301 11.0731 9.02634 11.2998 8.75301 11.2998Z"
                        fill="#101010"
                      />
                      <path
                        d="M9.83301 4.49967H7.16634C6.52634 4.49967 5.33301 4.49967 5.33301 2.66634C5.33301 0.833008 6.52634 0.833008 7.16634 0.833008H9.83301C10.473 0.833008 11.6663 0.833008 11.6663 2.66634C11.6663 3.30634 11.6663 4.49967 9.83301 4.49967ZM7.16634 1.83301C6.50634 1.83301 6.33301 1.83301 6.33301 2.66634C6.33301 3.49967 6.50634 3.49967 7.16634 3.49967H9.83301C10.6663 3.49967 10.6663 3.32634 10.6663 2.66634C10.6663 1.83301 10.493 1.83301 9.83301 1.83301H7.16634Z"
                        fill="#101010"
                      />
                      <path
                        d="M10.5 15.1669H6.5C2.75333 15.1669 2 13.4469 2 10.6669V6.66695C2 3.62695 3.1 2.32695 5.80667 2.18695C6.07333 2.17361 6.32 2.38028 6.33333 2.66028C6.34667 2.94028 6.13333 3.16695 5.86 3.18028C3.96667 3.28695 3 3.85361 3 6.66695V10.6669C3 13.1336 3.48667 14.1669 6.5 14.1669H10.5C13.5133 14.1669 14 13.1336 14 10.6669V6.66695C14 3.85361 13.0333 3.28695 11.14 3.18028C10.8667 3.16695 10.6533 2.92695 10.6667 2.65361C10.68 2.38028 10.92 2.16695 11.1933 2.18028C13.9 2.32695 15 3.62695 15 6.66028V10.6603C15 13.4469 14.2467 15.1669 10.5 15.1669Z"
                        fill="#101010"
                      />
                    </svg>
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <div className="w-[14%] flex text-2xl justify-between">
                  <div>
                    ...
                    >
                      <path
                        d="M5.98535 11.375C3.02535 11.375 0.610352 8.965 0.610352 6C0.610352 3.035 3.02535 0.625 5.98535 0.625C8.94535 0.625 11.3604 3.035 11.3604 6C11.3604 8.965 8.95035 11.375 5.98535 11.375ZM5.98535 1.375C3.43535 1.375 1.36035 3.45 1.36035 6C1.36035 8.55 3.43535 10.625 5.98535 10.625C8.53535 10.625 10.6104 8.55 10.6104 6C10.6104 3.45 8.53535 1.375 5.98535 1.375Z"
                        fill="#292D32"
                      />
                      <path
                        d="M5.005 7.97539H4.355C3.895 7.97539 3.625 7.71039 3.625 7.26539V4.73539C3.625 4.29039 3.9 4.02539 4.355 4.02539H5C5.46 4.02539 5.73 4.29039 5.73 4.73539V7.26539C5.735 7.71039 5.46 7.97539 5.005 7.97539ZM4.375 7.22539H4.985V4.77539H4.38L4.375 7.22539Z"
                        fill="#292D32"
                      />
                      <path
                        d="M7.64453 7.97539H6.99953C6.53953 7.97539 6.26953 7.71039 6.26953 7.26539V4.73539C6.26953 4.29039 6.54453 4.02539 6.99953 4.02539H7.64453C8.10453 4.02539 8.37453 4.29039 8.37453 4.73539V7.26539C8.37453 7.71039 8.09953 7.97539 7.64453 7.97539ZM7.01453 7.22539H7.62453V4.77539H7.01953L7.01453 7.22539Z"
                        fill="#292D32"
                      />
                    </svg>
                  </div>
              ...
              <div className="flex items-center w-full pl-3 mt-5">
                <div className="mr-3">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M8.66699 9.16699H4.66699C4.39366 9.16699 4.16699 8.94033 4.16699 8.66699C4.16699 8.39366 4.39366 8.16699 4.66699 8.16699H8.66699C8.94033 8.16699 9.16699 8.39366 9.16699 8.66699C9.16699 8.94033 8.94033 9.16699 8.66699 9.16699Z"
                      fill="#101010"
                    />
                    <path
                      d="M7.33366 11.833H4.66699C4.39366 11.833 4.16699 11.6063 4.16699 11.333C4.16699 11.0597 4.39366 10.833 4.66699 10.833H7.33366C7.60699 10.833 7.83366 11.0597 7.83366 11.333C7.83366 11.6063 7.60699 11.833 7.33366 11.833Z"
                      fill="#101010"
                    />
                  </svg>
                </div>
