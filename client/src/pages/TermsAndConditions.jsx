	...
	return (
		<div className="flex flex-col justify-center items-center bg-[#F2F2F7]">
			...
			<div className="max-w-[90vw] flex flex-col py-10 text-left justify-center items-start md:mb-5 lg:max-w-[70vw]">
				<p className="text-[#101010] font-extrabold md:text-[#6D6D6D]">
				...
				<p className="text-[#6D6D6D] text-sm mb-1">
					...
					with us directly to acertain the accuracy and adequacy of
				...
				<div className="text-[#6D6D6D] text-sm mb-1">
					...
					<div className="mt-2 md:mt-3 lg:mt-4">
						<span className="font-bold">Cookie: </span>This is a
						small amount of data generated by a website and saved by
						your web browser.
					</div>
					<div className="mt-2 md:mt-3 lg:mt-4">
						<span className="font-bold">Service: </span>This refers
				...
				<p className="text-[#6D6D6D] text-sm mb-1">
					We are committed to the user’s privacy, use of the website,
					data and other information or material about you, are
					subjected to our privacy policy, which explains how we use
				...
				<p className="text-[#6D6D6D] text-sm mb-1 ">
					Services and policies of this website may be changed,
