                ...
                <form onSubmit={handleSubmit}>
                    <div className="my-[44px] flex flex-col gap-[24px] ">
                        ...
                        <InputField
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                        id={"confirmPassword"} src={eyeslash} label={"Confirm Password"} type={"password"} placeholder={"confirm your password"} />
                    </div>
                    <div className="flex flex-col gap-[32px]">
                        <Button
                            className={"btn btnLong btnPrimary"}
                            children={"Register"}
                            type={"submit"} />
                        <Button
                            className={"btn btnLong btnSecondary"}
