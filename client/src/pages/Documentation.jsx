...
const docCards = (props) => {
	const { title, body, img, numb } = props;
	return (
		<div className="flex flex-col gap-4 md:flex-row md:gap-16 items-center w-full max-sm:gap-8 px-32">
			...
			<div className="flex-auto">
				<h2 className="text-[40px] font-semibold">{numb}</h2>
				<h2 className="text-[#0652DD] text-[40px] font-semibold">
					{title}
				</h2>
				<p className="">
					{body}
...
const docCards2 = (props) => {
	...
	return (
		<div className="flex flex-col-reverse gap-4 md:flex-row md:gap-16 items-center w-full max-sm:gap-8 px-32">
			<div className="flex-auto">
				<h2 className="text-[40px] font-semibold">{numb}</h2>
				<h2 className="text-[#0652DD] text-[40px] font-semibold">
					{title}
...
const docAuth = (props) => {
	const { title, body, img, textsec } = props;
	// const { sectitle, secbody } = textsec;
...
const docExFeat = (props) => {
	...
	return (
		<div className="flex flex-col-reverse gap-4 md:flex-row md:gap-16 w-full max-sm:gap-8 px-32">
			<div className="flex-auto">
				<p className="text-[40px] text-[#6D6D6D]">
					{body}
				</p>
			</div>
			<div className="flex-none">
		...
		<div>
			<div className="pt-0 bg-white pb-20">
				...
				<div className="pt-20 bg-[#CDDCF8]">
					<h1 className="text-4xl text-center font-bold mb-4 max-[698px]:text-2xl">
						Extra Features
					</h1>
					<div className="py-16">
						<div className="flex flex-col gap-6 md:flex-row mb-20">
