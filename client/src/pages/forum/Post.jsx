...
const Post = () => {
  return <>
    <main className='bg-[#f2f2f7] mx-0 my-0 py-5 px-16'>
        <div className='text-[40px] font-bold mb-5'>
        ...
        <div className='flex gap-3 items-center'>
            ...
            <div>
                ...
                <div className='flex gap-5 text-five text-base'>
                    <p className='text-[#bababa]'>November 14, 2022</p>
                </div>
            </div>
        </div>
        <form className='mt-5' method='post'>
            <div className='flex flex-col gap-3 h-[800px] bg-[#fcfcfc]'>
                ...
                <textarea rows='30' className='appearance-none outline-none resize-none bg-opacity-0 px-6' name="" id="" placeholder='Type text here' ></textarea>
            </div>
