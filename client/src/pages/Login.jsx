...
const Login = () => {
    ...
    return ( 
        ...
        <div className="lg:absolute top-[100px] px-[18px] py-[36px] md:p-[64px] rounded-lg bg-[#ffff]">
            ...
            <form onSubmit={handleSubmit}>
                <div className="my-[44px] flex flex-col gap-[24px] ">
                    <InputField
                        ...
                        className={errors.email && touched.email ? "!border-errorMain" : null}
                        value={values.email}
                ...
                <div className="flex flex-col gap-[24px]">
                    <div className="flex flex-col gap-[8px]">
                        <Button
                            className={"btn btnLong w-[100%] btnPrimary mt-0"}
                            children={"Login"}
                            type={"submit"} />
                            <p className="text-base text-stokeDark">Forgot password? <Link to="/" className="text-primaryMain font-bold ">Click here</Link></p>
                    </div>
                        <Button
