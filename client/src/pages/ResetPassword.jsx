            ...
            <div className="form-container">
                <form action="/reset">
                        ...
                        <div className="field confirm-password">
                            <div className="input-area password-field relative">
                                ...
                                <span className="hide-icon absolute top-[45px] right-[15px]" onClick={togglePassword2}>
                                    {passwordType2==='password' ? <BsFillEyeSlashFill/> : <BsFillEyeFill/> }
                                </span>
                            </div>                    
                        </div>
                    </div>
                    <div className="reset-password">
                        <Link to='/reset'>
                            <input type="submit" value={'Reset Password'} onClick={()=>{setShow(true)}} className="reset-btn text-center text-white w-full bg-[#0652DD] rounded-lg py-4 cursor-pointer hover:scale-x-[1.03]"/>
                        </Link>
                    </div>
