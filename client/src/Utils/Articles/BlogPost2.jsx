	...
	return (
		<section className="mb-32 lw:w-[1250px] lw:mx-auto">
			...
			<p className=" my-6 text-lg">
				...
				to receive your cover letter in your Telegram DM. For users that
				are generating their cover letter via website or Mobile App, you
				will receive a downloadable file on your cover letter on the
				Website or Mobile
			</p>
			<h6 className="text-lg font-bold mt-4 mb-3">
			...
			<p className=" my-6 text-lg mb-16">
