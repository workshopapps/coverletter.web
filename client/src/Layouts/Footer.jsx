...
//className="px-24 sm:block flex sm:justify-start justify-between items-end md:py-[18px] py-4 text-left text-xs bg-[#F2F2F7] text-textBody leading-4 sm:space-y-0 space-y-2">
//flex sm:flex-row flex-col justify-between  sm:space-y-0 space-y-4
