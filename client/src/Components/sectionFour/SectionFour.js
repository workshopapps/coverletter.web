...
function SectionFour() {
  ...
  return (
    <div>
        <main className='lg:px-[96px] flex flex-col justify-center'>
            <h2 className='text-2xl lg:text-4xl text-center font-bold py-10 lg:py-[96px] text-textBody'>What Others Are Saying...</h2>

            <div className="container flex flex-col w-[100%] lg:flex-row justify-center items-center gap-5   ">
                <div className="review w-[100%] lg:w-[90%] h-252px lg:h-[372px] text-left bg-textWhite flex flex-col p-5 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
                    ...
                    <img  className='w-12 my-[20px] lg:mt-[40%] mb-3  h-12 rounded-full' src={male} alt="" />
                ...
                <div className="review  w-[100%] lg:w-[90%] text-textBody lg:h-[372px] text-left bg-textWhite flex flex-col p-5 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
            ...
            <button className='px-9 py-3 mt-[85px] text-[14px] flex items-center justify-center w-[90%] lg:w-[30%] text-primaryMain border-[1.5px] border-solid border-blue-700 font-semibold rounded-lg'>
