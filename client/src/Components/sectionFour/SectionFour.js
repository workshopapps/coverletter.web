        ...
        <main className='lg:px-[96px] flex flex-col justify-center px[2px]'>
            ...
            <div className=" px-[7%] lg:px-[1px]  flex flex-col lg:flex-row justify-center items-center gap-5   ">
                <div className="review w-[100%] text-left bg-textWhite flex flex-col p-4 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
                    <p className='text-[16px] md:text-[18px] text-textBody' >I am impressed by the strength of the AI on this page and I think it's the best choice on the market and all over the world</p>
                    <img  className='w-12 my-[20px] lg:mt-[28%] object-cover mb-3  h-12 rounded-full' src={aloy} alt="" />
                ...
                <div className="review w-[100%]  text-textBody  text-left bg-textWhite flex flex-col p-4 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
                    <p className='text-[16px] md:text-[18px] text-textBody'>There are so many options and I love the templates options. This makes constructing cover letters easy.</p>
                    <img  className='w-12 text-textBody my-[20px] object-cover lg:mt-[28%] mb-3  h-12 rounded-full' src={bolu} alt="" />
                    <p className='font-bold text-[16px]'>Designer Bolu</p>
                    <span className='text-[14px] text-textBody ' >CEO, Bolu Arts</span>
                </div>
                <div className="review w-[100%] text-textBody  text-left bg-textWhite flex flex-col p-4 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
                    <p className='text-[16px] md:text-[18px]  text-textBody'>Really helpful with the format template that is provided and when you pair your resume with it makes it easier</p>
                ...
                <div className="review w-[100%] text-textBody text-left bg-textWhite flex flex-col p-4 py-4 pt-8 rounded-lg border-[1px] border-primaryLight ">
                    <p className='text-[16px] md:text-[18px]  text-textBody'>Quick and easy way to create a professional cover letter and allows for my own personal touch to the cover letter</p>
