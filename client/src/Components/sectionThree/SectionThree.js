        ...
        <div className="div  lg:px-[96px]  mt-10 mb-2">
           <main  className='  rounded-lg py-7 pb-[96px] relative bg-[#CDDCF8] '>
            ...
            <div className="top grid lg:px-[6rem] px-[7.5%]  lg:grid-cols-2 grid-cols-1 gap-[60px] lg:gap-[90px] ">
                <div className=" w-[327] h-[424px] lg:w-[100%] lg:h-[320px] py-10 bg-textWhite text-left px-[50px] lg:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={circle} className='w-[80px] mb-5 lg:mb-3 h-[80px]' alt="" />
                ...
                <div className=" w-[320] h-[424px] lg:w-[100%] lg:h-[320px] py-10 bg-textWhite text-left px-[50px] lg:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={pen} className='w-[80px] mb-5 lg:mb-3 h-[80px]' alt="" />
                ...
                <div className=" w-[327] h-[424px] lg:w-[100%] lg:h-[320px] py-10 bg-textWhite text-left px-[50px] lg:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={scissor} className='w-[80px] mb-5 lg:mb-3 h-[80px]' alt="" />
                ...
                <div className=" w-[327] h-[424px] lg:w-[100%] lg:h-[320px] py-10 bg-textWhite text-left px-[50px] lg:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={star} className='w-[80px] mb-5 lg:mb-3 h-[80px]' alt="" />
