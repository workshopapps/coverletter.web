...
function SectionTwo() {
  ...
  return (
    <div
      id="upload_section"
      className="px-5 z-20 relative bg-gray-100 py-[50px]"
    >
      <main className="flex flex-col items-start justify-center md:flex-row md:mt-[60px] md:px-5 lg:px-16 gap-5">
        <div className="left text-left text-gray-800   md:w-[50%] w-[100%] mb-[20px] md:mb-9  flex flex-col justify-center items-center ">
        ...
        <div
          className={`right md:w-[50%] h-[330px] sm:h-[443px] w-[100%] border-2 flex flex-col px-[8px] justify-center items-center ${
          ...
          <div className="uploadContainer relative flex flex-col md:px-[2vh] md:py-[15vh] py-[15vh]">
            ...
            {fileSize > 0 ? (
              ...
              <label for="upload_file" className="">
                ...
                <p className="text-grey300 text-[16px] text-center">File Supported: PDF</p>
                {fileSize > 5000000 ? fileValidation() : null}
                <button className="text-primaryMain w-full text-[16px]  mt-3 text-center font-bold ">
                  Or browse
                </button>
              </label>
            )}
