...
function InputData() {
	...
	return (
		<>
			{isLoading && (
				<div className="z-50 bg-overlay fixed top-0 bottom-0 w-full grid place-items-center">
					<div className="bg-white sm:h-[512px] sm:w-[600px] flex flex-col justify-center items-center gap-y-4 w-[300px] h-[376px]">
